...
def open_zoom_modal(img_path):
    ...
    st.markdown("<p style='text-align: center; color: #888; font-weight: bold;'>💡 คลิกพื้นที่ด้านนอก หรือกดเครื่องหมาย X มุมขวาบนเพื่อปิดหน้าต่างซูม</p>", unsafe_allow_html=True)
